...
/**
 * Rehype plugin that replaces `<pre><code class="language-mermaid">` blocks
 * with `<div class="mermaid-placeholder" data-mermaid="...">` so Shiki
...
/** Returns trimmed mermaid source if `node` is `<pre><code class="language-mermaid">`, else null. */
function extractMermaidSource(node: Element): string | null {
